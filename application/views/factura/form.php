            ...
            function clona_detalle(table,opc) {
                ...
                if (d == 0) {
                    ...
                    var fila = "<tr>"+
                                        ...
                                        "<td>"+
                                          "<input type ='text' class='form-control decimal' size='7' style='text-align:right' id='cantidad"+i+"' name='cantidad"+i+"' lang='"+i+"' onchange='validar_inventario_det(),validar_cantidad(1,this)'  value='"+cantidad.value +"' onkeyup='validar_decimal(this)'/>"+
                                        "</td>"+
                                        "<td>"+
